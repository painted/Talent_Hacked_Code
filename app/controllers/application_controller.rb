  ...
  protect_from_forgery with: :null_session
   ...
   # before_filter :sign_out_all_users, if: (:current_client && :current_developer)
  	...
  	def configure_permitted_parameters
    	...
    	devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:name, :dob, :gender, :email, :phone, :address, :bio, :interests, :skills, :qualifications, :experience, :dayRate, :exInd, :languages, :website, :github, :twitter, :facebook, :linkedinPublicUrl, :avatarUrl, :password, :password_confirmation, :current_password, :industry, :role, :mobile, :contact) }
