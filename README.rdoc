...
More importantly it is a business venture that Josh Fail-Brown along with Kate Hamilton, two makers graduates, are pursuing after the course. Members in the final project team (specified below) have each contributed to bring this application to life.
