...
describe 'developer profile form' do
	...
	context 'developer' do
		...
		it 'can fill-in/change their short bio' do
			fill_in "Bio", with: "Lorem Ipsum, Lorem Ipsum, Lorem Ipsum, Lorem Ipsum"
			click_update
			visit edit_developer_registration_path
			expect(find_field("Bio").value).to eq 'Lorem Ipsum, Lorem Ipsum, Lorem Ipsum, Lorem Ipsum'
		end
